...
deseq2_results_tetranscripts_tnf_vs_ctrl = as.data.frame(deseq2_results_tetranscripts_tnf_vs_ctrl)

maplot <- ggplot(deseq2_results_tetranscripts_tnf_vs_ctrl, aes(baseMean, log2FoldChange), colour="grey") +
