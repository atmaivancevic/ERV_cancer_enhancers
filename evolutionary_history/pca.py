...
df = pd.read_csv('/Shares/CL_Shared/data/atma/1_QUARANTINE/4_JUNE2020/trees_and_pcas/individual_copies/jalview_pca_transformed_points_allLTR10_min200_alignment.csv', sep=',')
#print(df)
