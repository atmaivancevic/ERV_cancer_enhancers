...
LTR10A/F elements were also plotted over histone marks from colorectal cancer cell lines (e.g. HCT116 H3K27ac ChIPseq, HCT116 H3K4me1 ChIPseq, etc; see [Fig1_deeptools_hct116.sbatch](pancancer_epigenomic_analysis/Fig1_deeptools_hct116.sbatch)). 
