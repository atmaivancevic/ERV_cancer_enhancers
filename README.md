...
Genome coordinates of LTR10 elements were obtained from Dfam. LTR10A and LTR10F elements were merged (within 2kb) and used to generate heatmaps from TCGA colon adenocarcinoma ATACseq ([deeptools_over_LTR10AF.q](pancancer_epigenomic_analysis/deeptools_over_LTR10AF.q)). Similar heatmaps were plotted using all LTR10 subfamilies (i.e. LTR10A, B, C, D, E, F & G; see ([deeptools_over_allLTR10subfamilies.q](pancancer_epigenomic_analysis/deeptools_over_allLTR10subfamilies.q)).   
